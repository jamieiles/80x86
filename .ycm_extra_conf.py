...
def GetCompilationInfoForFile( filename ):
  if 'sim/instructions' in filename:
    filename = os.path.join(os.path.dirname(__file__), 'sim', 'Emulate.cpp')
...
def FlagsForFile( filename, **kwargs ):
  ...
  return {
    'flags': final_flags + ['-isystem', '/usr/lib/llvm-3.8/lib/clang/3.8.0/include/'],
    'do_cache': True
  }
