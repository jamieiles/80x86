...
public:
    ...
    virtual void write_mem8(uint32_t addr, uint8_t val) = 0;
    virtual void write_mem16(uint32_t addr, uint16_t val) = 0;
    virtual void write_mem32(uint32_t addr, uint32_t val) = 0;
    virtual uint8_t read_mem8(uint32_t addr) = 0;
    virtual uint16_t read_mem16(uint32_t addr) = 0;
    virtual uint32_t read_mem32(uint32_t addr) = 0;
