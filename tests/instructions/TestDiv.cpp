...
using IDiv8Params = std::pair<const std::vector<uint8_t>,
      const std::vector<struct DivTest<int16_t, int8_t>>>;
using IDiv16Params = std::pair<const std::vector<uint8_t>,
...
INSTANTIATE_TEST_CASE_P(IDiv, IDivReg8Test,
    ::testing::Values(
        IDiv8Params({ 0xf6, 0xfb }, idiv8_tests)
    ));
...
INSTANTIATE_TEST_CASE_P(IDiv, IDivMem8Test,
    ::testing::Values(
        IDiv8Params({ 0xf6, 0x3f }, idiv8_tests)
    ));
...
INSTANTIATE_TEST_CASE_P(IDiv, IDivReg16Test,
    ::testing::Values(
        IDiv16Params({ 0xf7, 0xfb }, idiv16_tests)
    ));
...
INSTANTIATE_TEST_CASE_P(IDiv, IDivMem16Test,
    ::testing::Values(
        IDiv16Params({ 0xf7, 0x3f }, idiv16_tests)
    ));
