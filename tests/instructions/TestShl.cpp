...
INSTANTIATE_TEST_CASE_P(ShlN, ShiftRegImm8Test,
    ::testing::Values(
        // shl ax, imm8
...
INSTANTIATE_TEST_CASE_P(ShlN, ShiftMemImm8Test,
    ::testing::Values(
        // shl word [bx], imm8
...
INSTANTIATE_TEST_CASE_P(ShlN, ShiftRegImm16Test,
    ::testing::Values(
        // shl ax, imm16
...
INSTANTIATE_TEST_CASE_P(ShlN, ShiftMemImm16Test,
    ::testing::Values(
        // shl word [bx], imm16
